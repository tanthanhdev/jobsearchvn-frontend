...
export const Right = ({ Cv }) => {
  ...
  return (
    <div className={styles.wrapper}>
      <div data-v-48d91b5b="" className={`${styles["secondary-col"]} ${styles["position-relative"]}`}>
        <button data-v-48d91b5b="" className={`${styles["close"]}`}><i
          data-v-48d91b5b="" className={`${styles["fal"]} ${styles["fa-times"]}`}></i>
        </button>
        <div data-v-48d91b5b="" className={`${styles["p-3"]} ${styles["border-bottom"]}`}>
          <div data-v-48d91b5b="" className={`${styles["d-flex"]}`}>
            <img data-v-48d91b5b=""
              src={icons.logo} width="145px" className={`${styles["mb-2"]} ${styles["mr-auto"]}`} />
          </div>
          <div data-v-48d91b5b="" className={`${styles["d-flex"]} ${styles["align-items-start"]}`}>
            <div data-v-2a31697a="" data-v-48d91b5b="" className={`${styles["border"]} ${styles["avatar"]}`}
              style={{
            ...
            <div data-v-48d91b5b="" className={`${styles["ml-2"]}`}>
              <div data-v-48d91b5b="" className={`${styles["font-weight-bold"]} ${styles["cv-name"]} ${styles["h5"]} ${styles["mb-2"]}`}>
                {Cv.member.user.first_name + " " + Cv.member.user.last_name}
              </div>
              <div data-v-48d91b5b="" className={`${styles["cv-updated-at"]}`}>Cập nhật lần cuối: {dateUtils.timeSince(new Date(Cv.updated_at))}</div>
              <div data-v-48d91b5b="" className={`${styles["mt-2"]}`}>
              </div>
            </div>
          </div>
        </div>
        <div data-v-48d91b5b="" className={`${styles["p-3"]}`}>
          <div data-v-48d91b5b="" className={`${styles["border-bottom"]}`}>
            ...
            <div data-v-48d91b5b="" className={`${styles["px-3"]} ${styles["py-2"]} ${styles["cv-contact"]}`}>
              <div data-v-48d91b5b="">
                <i data-v-48d91b5b="" className={`${styles["fal"]} ${styles["fa-envelope"]} ${styles["mr-3"]}`}></i>
                <span data-v-48d91b5b="" className={`${styles["text-secondary-dark"]}`}>{Cv.member.user.email ? Cv.member.user.email : "[Chưa bổ sung]"}</span>
              </div>
              <div data-v-48d91b5b="">
                <i data-v-48d91b5b="" className={`${styles["fal"]} ${styles["fa-phone"]} ${styles["mr-3"]}`}></i>
                <span data-v-48d91b5b=""
                  className={`${styles["text-secondary-dark"]}`}>{Cv.member.user.phone_number ? Cv.member.user.phone_number : "[Chưa bổ sung]"}</span>
              </div>
            </div>
          ...
          <div data-v-48d91b5b="" className={`${styles["mb-2"]} ${styles["mt-2"]}`}>
            <button
              data-v-48d91b5b=""
              type="button"
              className={`${styles["btn"]} ${styles["min-width"]} ${styles["w-100"]} ${styles["cv-btn"]}
                ${isCvSaveExists ? styles["btn-primary"] : styles["btn-secondary"]}`}
          ...
          <div data-v-48d91b5b="" className={`${styles["border-bottom"]} ${styles["mb-3"]} ${styles["pb-3"]}`}>
            <hr data-v-48d91b5b="" className={`${styles["mt-3"]} ${styles["mb-3"]}`} />
            <div data-v-48d91b5b="" className={`${styles["mb-2"]} ${styles["font-weight-bold"]}`}>Giới thiệu ứng viên</div>
            <div data-v-48d91b5b="" className={`${styles["mb-2"]} ${styles["text-secondary-dark"]}`}>
              Nếu bạn cảm thấy ấn tượng với CV của {Cv.member.user.first_name + " " + Cv.member.user.last_name}. Thì đừng
              quên chia sẻ cho bạn bè, đồng nghiệp nhé.
            </div>
            <div data-v-48d91b5b="" className={`${styles["d-flex"]}`}>
              <div data-v-48d91b5b="" className={`${styles["v-popover"]} ${styles["mr-3"]} ${styles["w-100"]}`}>
