        ...
        {jobs && jobs.map((items, index) => (
          <>
            <a key={index} className="nav_sub-content-link coll l-4 m-6 c-12">
              <img src={items.employer.logo} alt={items.employer.company_name} className="nav_sub-content-logo" />
              <div className="nav_sub-content-description">
                ...
                <nav>
                  <div className="nav_sub-content-pay">
                    ...
                    <span>Lương: Trên {items.salary} {items.currency} </span>
                  </div>
                  <div className="nav_sub-content-location">
                    <i className="fas fa-map-marker-alt" />
                    <span>{items.employer.company_location}</span>
                  </div>
                  <span className="nav_sub-content-name">{items.employer.company_name}</span>
                </nav>
              </div>
            </a>
          </>
